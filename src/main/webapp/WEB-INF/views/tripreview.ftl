...
<div class="container">
    ...
    <form action="/trips/${trip.id}/review" method="POST">
        <div class="form-group row">
            <label class="col-sm-2 control-label">Отзыв</label>
            <div class="col-sm-10">
                                <textarea class="form-control" name="text" placeholder="Дополнительная информация"
                                          rows="10"></textarea>
            </div>
        </div>
        <div class="form-group row">
            <label for="trip" class="col-sm-2 col-form-label">Оценка</label>
            <div class="col-sm-10">
